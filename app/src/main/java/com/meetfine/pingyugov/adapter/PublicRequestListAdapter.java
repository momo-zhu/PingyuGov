 ...
 */
public class PublicRequestListAdapter extends ArrayAdapter<JSONObject> {
    private LayoutInflater inflater;
    private Context context;

    public PublicRequestListAdapter(Context context, List<JSONObject> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String date = Config.YEAR.format(new Date(Long.parseLong(temp)*1000));
