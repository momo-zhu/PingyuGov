 ...
 */
public class PublicRulesListAdapter extends ArrayAdapter<JSONObject> {
    private LayoutInflater inflater;
    private Context context;

    public PublicRulesListAdapter(Context context, List<JSONObject> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String dateTemp = item.getString("openness_date");
        createDate.setText(dateTemp);
