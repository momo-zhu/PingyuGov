...
public class ServiceItemDetailActivity extends KJActivity {
    ...
    public void initData() {
        ...
        contentId = getIntent().getStringExtra("parentId");
    ...
    public boolean hasSaved(){
        ...
        sb.append(String.format("type = %d",Config.favorTypes[2]));
...
//                    myFavor.setSiteId(String.valueOf(siteId));
    ...
    public void loadData(){
        ...
        drawable.start();
        new KJHttp.Builder().url(Config.HOST + "Service?id="+contentId)
                .callback(new HttpCallBack() {
                    ...
                    public void onSuccess(String t) {
                        ...
                        contentObj = result.getJSONObject("service");
                        setWidget();
                    }
...
//        settings.setLoadWithOverviewMode(true);// setUseWideViewPort方法设置webview推荐使用的窗口。setLoadWithOverviewMode方法是设置webview加载的页面的模式。
        ...
        sbCopy.append("浏览次数:").append(contentObj.getIntValue("views"));
